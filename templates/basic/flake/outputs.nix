  ...
  in {
    ...
    apps.CHANGEME-my-app = let
      CHANGEME-wrap-my-package = pkgs.writeShellScriptBin "CHANGEME-my-app" ''
        ...
        export G4NEUTRONHPDATA="${nain4.deps.g4-data-package.G4NDL}/share/Geant4-11.0.4/data/G4NDL4.6"
        export G4LEDATA="${nain4.deps.g4-data-package.G4EMLOW}/share/Geant4-11.0.4/data/G4EMLOW8.0"
        export G4LEVELGAMMADATA="${nain4.deps.g4-data-package.G4PhotonEvaporation}/share/Geant4-11.0.4/data/G4PhotonEvaporation5.7"
        export G4RADIOACTIVEDATA="${nain4.deps.g4-data-package.G4RadioactiveDecay}/share/Geant4-11.0.4/data/G4RadioactiveDecay5.6"
        export G4PARTICLEXSDATA="${nain4.deps.g4-data-package.G4PARTICLEXS}/share/Geant4-11.0.4/data/G4PARTICLEXS4.0"
        export G4PIIDATA="${nain4.deps.g4-data-package.G4PII}/share/Geant4-11.0.4/data/G4PII1.3"
        export G4REALSURFACEDATA="${nain4.deps.g4-data-package.G4RealSurface}/share/Geant4-11.0.4/data/G4RealSurface2.2"
        export G4SAIDXSDATA="${nain4.deps.g4-data-package.G4SAIDDATA}/share/Geant4-11.0.4/data/G4SAIDDATA2.0"
        export G4ABLADATA="${nain4.deps.g4-data-package.G4ABLA}/share/Geant4-11.0.4/data/G4ABLA3.1"
        export G4INCLDATA="${nain4.deps.g4-data-package.G4INCL}/share/Geant4-11.0.4/data/G4INCL1.0"
        export G4ENSDFSTATEDATA="${nain4.deps.g4-data-package.G4ENSDFSTATE}/share/Geant4-11.0.4/data/G4ENSDFSTATE2.3"
